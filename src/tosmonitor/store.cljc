(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Brookdale Senior Living Inc., LEI
  LH7MQB13NWY7CJ9VC445) -- unlike `commitledger.store`'s multi-application
  ...
  NOTE: this company's own archived doc-type is `:terms-of-use` (not
  `:terms-of-service`) -- the exact real-world case that surfaced
  `tosmonitor.registry/known-doc-types` being a guessed, not archive-
  grounded, vocabulary during this batch (see ADR-2607242000 Decision 3;
  the pilot's registry.cljc was fixed before this repo was built).
...
(defn demo-company []
  {:legal-name "Brookdale Senior Living Inc."
   :website    "https://www.brookdale.com"})

(def ^:private demo-full-text
  "Terms of Use\nThese Terms of Use govern your access to and use of the Brookdale Senior Living Inc. website, including its privacy policy content. By using this site you agree to these Terms, which may be revised without notice. This agreement is governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.brookdale.com/en/privacy-policy/terms-of-use.html"
